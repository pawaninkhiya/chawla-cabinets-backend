...
import { createModelVerityController, deleteModelVerityController, getAllModelVerityController, updateModelVerityController } from "../controllers/modelVerity.controller";
